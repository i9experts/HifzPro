...
const MODULES = [
  ...
  { href: "/dashboard/admin/batches",      icon: "👥", title: "Batch Management",     titleUrdu: "حلقہ مینجمنٹ",   desc: "Create & manage halqas and assign Asatidha", color: "#7c3aed",       bg: "#f5f3ff",       border: "#ddd6fe",        badge: "" },
  { href: "/dashboard/admin/attendance",   icon: "📅", title: "Attendance Reports",   titleUrdu: "حاضری رپورٹس",   desc: "Campus-wide attendance analytics",            color: "#b45309",       bg: "#fffbeb",       border: "#fde68a",        badge: "" },
  { href: "/dashboard/admin/analytics",    icon: "📊", title: "Analytics Dashboard",  titleUrdu: "تجزیاتی لوحہ",   desc: "Manzil health, dropout risk & insights",     color: "#0f766e",       bg: "#f0fdfa",       border: "#99f6e4",        badge: "" },
  { href: "/dashboard/admin/tests",        icon: "📝", title: "Tests & Assessments",  titleUrdu: "امتحانات",        desc: "Para tests, Sanad tests & results",           color: "#be185d",       bg: "#fdf2f8",       border: "#fbcfe8",        badge: "" },
  { href: "/dashboard/admin/fees",      icon: "💰", title: "Fee Management",       titleUrdu: "فیس مینجمنٹ",    desc: "Fee structures, payments & scholarships",    color: "#15803d",       bg: "#f0fdf4",       border: "#bbf7d0",        badge: "" },
  { href: "/dashboard/admin/whatsapp",     icon: "💬", title: "WhatsApp Notifications",titleUrdu: "واٹس ایپ",      desc: "Parent updates, alerts & messaging",         color: "#16a34a",       bg: "#f0fdf4",       border: "#bbf7d0",        badge: "" },
  { href: "/dashboard/admin/sanads",       icon: "🏛",  title: "Sanads & Certificates",titleUrdu: "سند / اجازہ",   desc: "Issue QR-verified Sanads & Ijazahs",         color: colors.gold,     bg: "#fffbeb",       border: "#fde68a",        badge: "" },
  { href: "/dashboard/admin/asatidha",     icon: "🧑‍🏫", title: "Asatidha Management", titleUrdu: "اساتذہ",         desc: "Add, manage & assign Asatidha",              color: colors.n600,     bg: colors.n50,      border: colors.n200,      badge: "" },
];
