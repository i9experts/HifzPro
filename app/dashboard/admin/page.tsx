...
const MODULES = [
  ...
  { href: "/dashboard/admin/fees",      icon: "💰", title: "Fee Management",       titleUrdu: "فیس مینجمنٹ",    desc: "Fee structures, payments & scholarships",    color: "#15803d",       bg: "#f0fdf4",       border: "#bbf7d0",        badge: "SOON" },
